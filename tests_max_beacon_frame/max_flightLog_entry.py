...
#telemetry
dji_payload=b'Xb\x13\x10\x02M\x063\x1f0K1CG6G3AH8V2y\x00\x30\x30\xf0\x00\x05\x00\x00\x00\x00\xef\xff\x0c\x00\x00\x00\x00\x00\x00\x00\x00C\x00\x00\x00\x00\x99\x01\x00\x00A\xf9|\x00\xcc='
...
packet = RadioTap() / Dot11() / beacon_fields / ie_ssid / ie_rates /ie_vendor_dji/vendor1/vendor2/vendor3/vendor4/vendor5
...
#Only mandatory beacon fields, the dji payload is equal to the one in max_fields_before_dji_payload.py but with bytes related to UUID different from ascii characters. The remaining 54 bytes that are not parsed but present in the raw data are chosen in a way that they generate decimals of 3 numbers (\x96, to increase the space faster). Indeed, in this way it generates bigger entries in the flightLog file ~ 20 rows.
