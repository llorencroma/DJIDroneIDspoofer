...
# Telemetry 1
vendor_payload1 = b'Xb\x13\x10\x02M\x063\x1f446FG9T7SD6V6U\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xef\xff\x0c\x00\x00\x00\x00\x00\x00\x00\xb0C\x85\xb3\xa0(v\x01\x00\x00E\x89|\x00\xcc=\x14\x00\x00\x00\x00\x00\x00\x00\x00\x00\x18\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'

# Telemetry 2
vendor_payload2 = b'Xb\x13\x10\x02M\x063\x1f431CG6G3AH8V2M\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xef\xff\x0c\x00\x00\x00\x00\x00\x00\x00\xb0C\x85\xb3\xa0(v\x01\x00\x00E\x89|\x00\xcc=\x14\x00\x00\x00\x00\x00\x00\x00\x00\x00\x18\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'




# Vendor Specific: 26:37:12 (DJI)
ie_vendor_dji1 = Dot11EltVendorSpecific(ID=221, len = len(vendor_payload1) + 3 ,oui=0x263712, info = vendor_payload1)
ie_vendor_dji2 = Dot11EltVendorSpecific(ID=221, len = len(vendor_payload2) + 3 ,oui=0x263712, info = vendor_payload2)
# Flight Info
...
packet = RadioTap() / Dot11() / beacon_fields / ie_ssid / ie_rates / ie_vendor_dji1/ie_vendor_dji2
...
#the Aeroscope detects only the first vendor
