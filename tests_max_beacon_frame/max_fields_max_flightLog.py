...
ie_tim = Dot11Elt(ID=5, len=len(payload), info = payload)

# == Non Mandatory IE:Country == #
ie_country=Dot11Elt(ID=7, len=7, info=b'\x06\x43\x48\x00\x01\x0d\x14')
...
#Same as max_fields_before_dji_payload.py but with the payload of max_flightLog_entry.py ~ 20 rows


#same as sendBeaconDJI but with the payload of trial3.py
